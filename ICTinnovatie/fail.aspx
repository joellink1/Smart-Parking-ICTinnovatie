<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fail.aspx.cs" Inherits="ICTinnovatie.fail" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Label ID="Label6" runat="server" Text="Er zijn geen vrije plekken in deze parkeergarage. Kies een andere parkeergarage" ForeColor="Red" Font-Bold="true"></asp:Label>
        </div>
    </form>
</body>
</html>
